...
/*   Updated: 2020/02/13 15:25:26 by scleerdi      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
static void		flutes(t_op operation)
{
...
static void		drums(t_stacks *ab, t_op operation)
{
	if (operation == e_pa)
	{
		ab->size_a++;
